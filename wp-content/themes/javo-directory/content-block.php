...
<div class="container" id="javo-user-404-page-wrap">
	<div class="row">
		<div class="col-md-12">
			<h1 class="page-header text-center"><?php _e('Cannot Access', 'javo_fr');?></h1>
		</div><!-- /.col-md-12 -->
	</div><!--/.row -->
	<div class="row">
		<div class="col-md-12">
			<h3 class="text-center"><?php _e( "This page has been forbidden to access by adminstrator. Please contact to administrator", 'javo_fr');?></h3>
		</div><!-- /.col-md-12 -->
	</div><!--/.row -->
	<div class="row">
		<div class="col-md-12">
